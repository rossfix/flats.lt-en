export const articleOne = {
  ...
  header: "NT nuomos patarimas nr1: kaip surasti gerus nuomininkus",
  firstpar:
    "Nors nuomojant nekilnojamąjį turtą gali būti pelninga, tačiau tai taip pat gali kelti keletą iššūkių, ypač jei kalbame apie suradimą gerų nuomininkų. Viena iš svarbiausių taisyklių yra gerai susipažinti su potencialiais nuomininkais ir patikrinti jų kredito istoriją bei pajamas. Taip pat rekomenduojame susitikti su potencialiais nuomininkais asmeniškai ir paklausti apie jų planus ir lūkesčius, taip pat paklausti jų praeitų nuomininkų rekomendacijas. Be to, patariame nuomotis tik pagal rašytinius sutartis, kad būtų aiškiai nustatytos visos nuomos sąlygos ir atsakomybės.",
  scndheader: "NT nuomos patarimas nr2: kaip sumažinti nuomos sąnaudas",
  scndpar:
    "Nuomojant nekilnojamąjį turtą, svarbu stengtis sumažinti nuomos sąnaudas, kad būtų užtikrintas pelnas. Vienas iš būdų yra sumažinti nuomos kainą, tačiau tai gali neigiamai paveikti nuomos pasiūlą. Taip pat, galima atidžiai stebėti ir valdyti nuomos sąnaudas, pavyzdžiui, peržiūrėti energijos sąskaitas ir ieškoti būdų sumažinti jas arba atidžiai planuoti remontus ir renovacijas. Galiausiai svarbu įsitikinti, kad nuomojamas turtas yra gerai prižiūrimas ir geros būklės, nes tai gali padėti pritraukti nuomininkus ir laikui bėgant sumažinti remonto išlaidas.",
  trdheader: "NT nuomos patarimas nr3: kaip užtikrinti nuomos mokėjimus",
  trdpar:
    "Viena iš svarbiausių NT nuomos patarimų yra užtikrinti, kad nuomininkai mokėtų laiku ir visą nuomos sumą. Rekomenduojame nustatyti fiksuotą nuomos mokėjimo dieną ir naudoti automatizuotas mokėjimo sistemas, kad būtų užtikrintas reguliarus ir laiku mokėjimas. Be to, patariame stiprinti nuomos sutartį ir nustatyti pasekmes, jei nuomininkai nevykdo savo mokėjimo įsipareigojimų. Taip pat rekomenduojame patikrinti nuomininkų kredito istoriją ir pajamas, kad būtų mažesnė rizika, jog jie nevykdys mokėjimo įsipareigojimų.",
  frthheader: "NT nuomos patarimas nr4: kaip padidinti nuomos pelną",
  frthpar:
  ...
  firstimg:
    "https://firebasestorage.googleapis.com/v0/b/flats-af6d2.appspot.com/o/articles%2Fnt-nuomos-patarimai-lietuvoje%2Fnt_nuoma_ir_patarimai.jpg?alt=media&token=873d8521-fd14-4e86-9055-401890897c6c",
  firstalt:
    "Nekilnojamasis turtas Lietuvoje: patarimai, kaip pasirinkti geriausią NT nuomos pasiūlymą savo nuosavybei",
  scndimg:
    "https://firebasestorage.googleapis.com/v0/b/flats-af6d2.appspot.com/o/articles%2Fnt-nuomos-patarimai-lietuvoje%2Fnt_nuomos_patarimai_lietuvoje.jpg?alt=media&token=b5dfe062-da66-4198-88f3-251d40406d12",
  scndalt:
    "NT nuoma Lietuvoje: patarimai, kaip padidinti savo nekilnojamojo turto nuomos pelną",
  trdimg:
...
export const articleTwo = {
  ...
  headerone: "Buto nuomos mokesčiai Lietuvoje",

  header: "Pasirinkimas tarp verslo liudijimo ar 15% GPM",
  firstpar:
    "Lietuvoje buto nuomos mokesčiai gali būti mokami dvejopai - su verslo liudijimu arba nuo gautų pajamų mokamas 15% gyventojų pajamų mokestis (GPM). Kuo skiriasi šie mokesčių būdai ir kurį geriau pasirinkti?",
  scndheader: "Buto nuomos mokesčiai Lietuvoje su verslo liudijimu",
  scndpar:
    "Jei nuomojate butą profesionaliai ir nuomos veikla yra nuolatinė, tai turėtumėte įsigyti verslo liudijimą. Verslo liudijimo kaina priklauso nuo vietovės, kurioje nuomojate būstą. Pavyzdžiui, Vilniaus miesto savivaldybėje gyvenamųjų patalpų nuomos liudijimo kaina yra didžiausia - 684 eurai per metus, mažesnėse savivaldybėse ji kainuoja ženkliai mažiau. Be to, reikia sumokėti metinius mokesčius už nekilnojamąjį turtą ir papildomus mokesčius, jei nuomoja butus išvykstančioms asmenims ar keliais butais viename objekte.",
  trdheader: "Buto nuomos mokesčiai Lietuvoje su 15% GPM",
  trdpar:
    "Kita alternatyva yra mokėti mokesčius nuo gautų pajamų, taikant 15% GPM. Šiuo atveju reikia deklaruoti gautas pajamas metiniame mokesčių deklaravime, tačiau negalima naudoti jokių išlaidų kaip atskaitymas. Tai gali būti paprastesnė pasirinktis asmenims, kurie turi tik vieną būstą ar keletą būstų ir laiko šią veiklą ne pagrindiniu pajamų šaltiniu.",
  frthheader: "Konsultacijos ir patarimai",
  frthpar:
  ...
  firstimg:
    "https://firebasestorage.googleapis.com/v0/b/flats-af6d2.appspot.com/o/articles%2Fbuto-nuomos-mokesciai-lietuvoje%2Fbuto-nuomos-mokesciai-lietuvoje.jpg?alt=media&token=0f3eb6aa-efd0-4ffd-a400-6070c354835d",
  firstalt:
    "Buto nuoma Lietuvoje: patarimai, kaip apskaičiuoti ir sumokėti mokesčius",
  scndimg:
    "https://firebasestorage.googleapis.com/v0/b/flats-af6d2.appspot.com/o/articles%2Fbuto-nuomos-mokesciai-lietuvoje%2Fbuto-nuomos-mokesciai.jpg?alt=media&token=99be6584-0206-4f70-acd0-7374ee03eff3",
  scndalt:
    "Buto nuomos mokesčiai Lietuvoje: patarimai, kaip apsaugoti save nuo neteisingo mokesčių apskaičiavimo",
  trdimg:
...
export const articleThree = {
  ...
  firstpar:
    "Buto nuomos sutartis yra dokumentas, kuris reguliuoja santykius tarp nuomotojo ir nuomininko dėl buto nuomos. Sutartis turi apimti esminius klausimus, tokius kaip nuomos trukmė, nuomos mokestis, atsakomybę už remonto darbus ir kt. Todėl, svarbu suprasti, kokie yra pagrindiniai dalykai, kuriuos reikia įtraukti į buto nuomos sutartį. Sutartis yra svarbi, nes ji apsaugo tiek nuomotojo, tiek nuomininko interesus ir užtikrina, kad abi pusės laikytųsi nustatytų sąlygų.",
  scndheader: "Buto nuomos sutarties sudarymas: reikalingi duomenys",
  scndpar:
    "Norint sudaryti teisėtą ir tinkamą buto nuomos sutartį, reikia surinkti tam tikrus duomenis. Tai apima nuomotojo ir nuomininko asmens duomenis, buto adresą, nuomos trukmę, nuomos mokestį, remonto darbų ir kt. sąlygas. Be to, rekomenduojame apibrėžti taisykles dėl išnuomojimo, taip pat nuomininko atsakomybę už padarytas žalas.",
  trdheader: "Buto nuomos sutarties pavyzdys",
  trdpar:
    "Norint geriau suprasti, kokie punktai turi būti įtraukti į buto nuomos sutartį, pateikiame kokie dažniausiai sutartyje sutinkami punktai: sutarties šalys (nuomotojo vardas, kontaktiniai duomenys ir nuomininko vardas, kontaktiniai duomenys), butas (buto adresas ir trumpas buto aprašymas), nuomos laikotarpis (laikotarpis nuo (data) iki (data)), nuomos mokestis (suma - nuomos mokestis eurais, mokėjimo tvarka bei nuomos mokėjimo terminas), depozitas (depozito suma eurais ir sąlygos dėl jo grąžinimo), atsakomybė už žalas (sąlygos, apibrėžiančios kas atsako už padarytas žalas), nuomos taisyklės (taisyklės, apibrėžiančios sąlygas, kas yra leistina patalpose). Svarbu atkreipti dėmesį, kad tai yra tik patarimas, ir sutarties turinys gali skirtis priklausomai nuo konkretaus atvejo, teisės aktų ir poreikių. Jeigu kyla klausimų arba reikia pagalbos ruošiant sutartį, galite kreiptis į mus ir mes Jums padesime.",
  frthheader: "Nekilnojamo turto perdavimo priemimo aktas",
  frthpar:
  ...
  firstimg:
    "https://firebasestorage.googleapis.com/v0/b/flats-af6d2.appspot.com/o/articles%2Fbuto-nuomos-sutartis%2Fbuto-nuomos-sutartis.jpg?alt=media&token=d7d8047c-4e95-46fd-af6f-d593919a1cdb",
  firstalt:
    "Buto nuoma Lietuvoje: patarimai, kaip sudaryti ir sutarti dėl nuomos sąlygų",
  scndimg:
    "https://firebasestorage.googleapis.com/v0/b/flats-af6d2.appspot.com/o/articles%2Fbuto-nuomos-sutartis%2Fnt-nuomos-sutartis.jpg?alt=media&token=53bda165-53b5-41ab-ba9f-e2dd8ad431e1",
  scndalt:
    "Buto nuomos sutartis Lietuvoje: patarimai, kaip apsaugoti save nuo neteisingų sąlygų",
  trdimg:
...
export const articleFour = {
  ...
  header: "Apie ilgalaikę butų nuoma",
  firstpar:
    "Ilgalaikė buto nuoma yra populiari pasirinktis tiek nuomotojams, tiek nuomininkams. Tai leidžia nuomininkams ilgalaikį stabilų gyvenamąjį komfortą, o nuomotojams – stabilų ir ilgalaikį nuomos mokestį. Tačiau, kaip ir bet kurioje srityje, ilgalaikės nuomos privalumai gali turėti ir trūkumų, todėl rekomenduojame gerai apgalvoti savo sprendimą.",
  scndheader: "Pasiruošimas nuomai",
  scndpar:
    "Jeigu nusprendėte nuomoti savo butą ilgam laikui, rekomenduojame gerai pasiruošti. Tai apima patikrinimą, ar butas atitinka visus reikalavimus, sutarimą dėl nuomos mokesčio, taip pat atsakomybės už remontą ir kitus klausimus. Be to, rekomenduojame pasiruošti ir savo finansus, kad būtų užtikrintas stabilus ir ilgalaikis nuomos mokestis.",
  trdheader: "Sutarties sudarymas ir svarba",
  trdpar:
    "Ilgalaikės buto nuomos sutartyje rekomenduojame apibrėžti visus klausimus, susijusius su nuomos santykiais, tokius kaip nuomos mokestis, atlyginimas už žalas, išnuomojimo taisyklės ir kt. Tai yra svarbu ne tik dėl teisinių klausimų, bet ir dėl abipusio supratimo ir santykių gerinimo. Be to, patariame konsultuotis su profesionalais, kad užtikrintumėte, kad sutartis yra teisėta ir tinkama.",
  frthheader: "Ilgalaikė butų nuoma: rekomendacijos nuomotojams",
  frthpar:
  ...
  firstimg:
    "https://firebasestorage.googleapis.com/v0/b/flats-af6d2.appspot.com/o/articles%2Ftrumpalaike-ilgalaike-nuoma%2Fkuo-skiriasi-trumpalaike-ilgalaike-nuoma.jpg?alt=media&token=31e54516-9c5a-447e-8b61-666dcd9dddb1",
  firstalt:
    "Buto nuoma Lietuvoje: trumpalaikė ar ilgalaikė butų nuoma? Patarimai, kaip pasirinkti geriausią variantą",
  scndimg:
    "https://firebasestorage.googleapis.com/v0/b/flats-af6d2.appspot.com/o/articles%2Ftrumpalaike-ilgalaike-nuoma%2Ftrumpalaike-ar-ilgalaike-nuoma.jpg?alt=media&token=2b2ac5ac-2f49-43e3-ba22-928387fe08e7",
  scndalt:
    "Trumpalaikė ar ilgalaikė butų nuoma Lietuvoje: patarimai, kaip apskaičiuoti ir sutarti dėl nuomos kainos",
  trdimg:
...
export const articleFive = {
  ...
  headerone: "Legali buto nuoma - kas tai?",

  header: "Legali buto nuoma: kas tai ir kodėl ji svarbi?",
  firstpar:
    "Legali buto nuoma yra nuoma, kurioje abi pusės - nuomininkas ir nuomotojas - laikosi visų įstatymų ir reikalavimų, susijusių su nuomos sutartimis. Tai apima laikytis nuomos sutarties ir mokėti visus mokesčius, susijusius su nuomojamu būstu. Legali buto nuoma yra svarbi, nes ji apsaugo tiek nuomotojo, tiek nuomininko interesus ir užtikrina, kad abi pusės laikytųsi nustatytų sąlygų.",
  scndheader: "Kodėl svarbu sudaryti legalią buto nuomos sutartį",
  scndpar:
    "Sudaryti legalią buto nuomos sutartį yra svarbu tiek nuomotojui, tiek nuomininkui. Sutartis apsaugo abiejų pusių interesus ir užtikrina, kad abi pusės laikytųsi nustatytų sąlygų. Be to, legali sutartis gali padėti išvengti bet kokių nesusipratimų ar ginčų dėl nuomos mokesčių ar kitų sąlygų. Rekomenduojame susisiekti su nekilnojamojo turto agentu arba advokatu, kuris gali padėti sudaryti teisingą ir apsaugantį jūsų interesus nuomos sutartį.",
  trdheader: "Kaip užtikrinti, kad buto nuoma būtų legali",
  trdpar:
    "Sudarykite nuomos sutartį ir laikykitės jos sąlygų. Sutartyje turėtų būti nurodytos visos sąlygos, susijusios su nuoma, įskaitant mokesčius, nuomos trukmę, nuomojamo būsto nuomos kainą ir pan. Mokėkite visas nuomos mokesčius laiku. Tai apima visus mokesčius, susijusius su nuomojamu būstu, pavyzdžiui, nuomos mokestį, mokesčius už elektros ar dujų naudojimą ir pan. Laikykitės visų įstatymų ir reikalavimų, susijusių su buto nuoma jūsų vietoje. Tai gali apimti mokesčius, sąlygas dėl kainų pakeitimų ar nuomininkų atsakomybę už nuostolius.",
  frthheader: "Kaip apsaugoti save sudarant legalią buto nuomos sutartį",
  frthpar:
  ...
  firstimg:
    "https://firebasestorage.googleapis.com/v0/b/flats-af6d2.appspot.com/o/articles%2Flegali-buto-nuoma%2Fkas-yra-legali-buto-nuoma-vilniuje.jpg?alt=media&token=7c0cbb08-7ec8-43ad-8ef7-e5e47cc50f98",
  firstalt:
    "Buto nuoma Lietuvoje: kaip užtikrinti legalią nuomą ir apsisaugoti nuo problemų?",
  scndimg:
    "https://firebasestorage.googleapis.com/v0/b/flats-af6d2.appspot.com/o/articles%2Flegali-buto-nuoma%2Fkas-yra-legali-buto-nuoma.jpg?alt=media&token=d7b05041-558f-4a90-8755-bc189aa6ab4f",
  scndalt:
    "Legali buto nuoma Lietuvoje: patarimai, kaip apsisaugoti nuo neteisingų sąlygų ir problemų",
  trdimg:
...
export const articleSix = {
  ...
  headerone: "Nekilnojamojo turto nuoma: nuo ko pradėti?",

  header: "Nusistatykite tikslus",
  firstpar:
    "Nekilnojamojo turto nuoma yra geras būdas uždirbti pinigus ir sukurti stabilų pajamų šaltinį, tačiau pradedant nuomoti nekilnojamąjį turtą gali kilti daug klausimų. Pirmiausia, rekomenduojame išsikelti tikslus, t.y. apsispręsti dėl nekilnojamojo turto tipo, kainos ir svarbiausia vietos.",
  scndheader: "Nekilnojamojo turto paieška",
  scndpar:
    "Pirmas žingsnis tapti nekilnojamo turto nuomos nuomininku yra rasti patrauklų nekilnojamąjį turtą. Nekilnojamo turto vieta yra svarbi, nes ji nuspręs, kokio tipo nuomininkus jūs patrauksite ir kokio dydžio pajamas galėsite generuoti iš nuomos. Ieškokite nekilnojamo turto patraukliose vietose, arti mokyklų, parduotuvių ir viešojo transporto. Reikės apsvarstyti dydį, būklę ir biudžetą. Taip pat svarbu ištirti vietinę nekilnojamo turto nuomos rinką, kad suprastumėte, kiek pajamų ir kokių išlaidų tikėtis ir kt. Kai surasite tinkamą nekilnojamą turtą, būtinai atlikite išsamų patikrinimą, kad nustatytumėte potencialius klausimus, kuriuos reikės spręsti prieš jį nuomojant.",
  trdheader: "Teisiniai klausimai",
  trdpar:
    "Kai rasite tobulą nekilnojamą turtą, svarbu sudaryti kokybišką nekilnojamo turto nuomos sutartį, kurioje bus nurodyti sutarties terminai ir sąlygos. Nekilnojamo turto nuomos sutartyje turėtų būti nurodyta nuomos kaina, objektas, nuomos laikotarpis, atsakomybė už priežiūrą ir remontą ir ką daryti, jei nuomininkas pažeidžia sutartį. Būtinai patikrinkite, ar atitinkate įstatymų reikalavimus, susijusius su nekilnojamo turto nuoma, jei sutartis bus paruošta pernelyg 'skriaudžianti' nuominiką, ją galima apskųsti. Šis procesas gali būti sudėtingas, todėl gali būti naudinga konsultuotis su teisininku ar profesionaliu nekilnojamo turto valdytoju, kad užtikrintumėte visus aspektus.",
  frthheader: "Nekilnojamo turto valdymas",
  frthpar:
  ...
  firstimg:
    "https://firebasestorage.googleapis.com/v0/b/flats-af6d2.appspot.com/o/articles%2Fnekilnojamo-turto-nuoma%2Fnekilnojamo-turto-nuoma-vilniuje.jpg?alt=media&token=78393d13-87fc-439b-b053-d8777ef50f4f",
  firstalt:
    "Nekilnojamasis turtas Lietuvoje: patarimai, kaip sutarti dėl nuomos sąlygų ir apsaugoti savo teises",
  scndimg:
    "https://firebasestorage.googleapis.com/v0/b/flats-af6d2.appspot.com/o/articles%2Fnekilnojamo-turto-nuoma%2Fnekilnojamo-turto-nuoma.jpg?alt=media&token=6473ae6d-a883-4cf1-82e5-aba20172126c",
  scndalt:
    "Nekilnojamo turto nuoma Lietuvoje: patarimai, kaip apskaičiuoti ir sumokėti mokesčius",
  trdimg:
...
export const articleEight = {
  ...
  firstpar:
    "Kaip nuomotojo, jūsų tikslas yra užpildyti savo nuomojamąjį turtą kuo greičiau, siekiant padidinti užimtuma bei pajamas. Tačiau patikimų nuomininkų rasti gali būti laiko reikalaujantis ir sudėtingas uždavinys. Pirmasis žingsnis, kad greitai išnuomotumėte savo butą, yra sukurti patrauklų skelbimą. Tai reiškia, kad turėtumėte pateikti detalią informaciją apie turtą, įskaitant kambarių ir vonios kambarių skaičių, kvadratinių metrų skaičių ir bet kokias specialias savybes ar patogumus. Be to, turėtumėte įtraukti aukštos kokybės nuotraukas. Sukūrus patrauklų skelbimą, greičiausiai sudominsite potencialių nuomininkų dėmesį. Įsitikinkite, kad pateikiate visus geriausius buto bruožus, tokius kaip medinės grindys, atnaujintos buitinės technikos ir pakankamai natūralios šviesos. Įtraukite grindų planus ir matavimus ir parodykite aplinkinį rajoną, įtraukiant nuotraukas iš artimiausių parkų, kavinukių, viešojo transporto ir tt. Atskleidžiant vietos unikalias privilegijas, susilaukite patikimą nuomininką.",
  scndheader: "Naudokite keletą skelbimo platformų",
  scndpar:
    "Norėdami parodyti savo butą kuo daugiau potencialių nuomininkų, svarbu jį skelbti keliose platformose. Tai apima populiarias nuomos svetaines, vietinius laikraščius ir socialinius tinklus. Taip pat galite susisiekti su vietiniais nekilnojamojo turto agentais ar NT administratoriais, kurie gali susisiekti su susidomėjusiais nuomininkais už jus. Skelbiant savo turtą keliose platformose, padidinsite savo galimybes greitai išnuomoti būstą. Taip pat neapsiribokite tik internetinėmis platformomis, apsvarstykite skelbimų stendų ar plakatų paskelbimą, galite susisiekti su vietiniais universitetais ar kolegijomis, jei manote, kad jūsų nuoma būtų tinkama studentams. Kuo daugiau pasirinkimų turite, tuo didesnės yra galimybės rasti nuomininką greičiau.",
  trdheader: "Patraukli nuomos kaina",
  trdpar:
    "Kitas svarbus veiksnys yra patraukli nuomos kaina. Kai kalbama apie greitą ir efektyvų buto nuomos procesą reikia atsižvelgti į nekilnojamojo turto rinkos kainas ir nustatyti kainą, kuri būtų prieinama nuomininkams, bet tuo pačiu metu neperžengtų jų galimybių. ei nuomos kaina yra per aukšta, potencialūs nuomininkai gali būti atbaidyti ir jums gali tekti ilgiau laukti, kol rasite tinkamą nuomininką. Tačiau, jei nuomos kaina yra per žema, jūs prarasite pelną ir gali pritraukti nuomininkus, kurie nebus patikimi ar neatsakingi. Rekomenduojama atlikti tyrimus ir susipažinti su apylinkių nuomos kainomis, kad galėtumėte nustatyti patrauklią ir teisingą kainą savo butui.",
  frthheader: "Būkite visuomet pasiekiami, tai padės greitai išnuomoti būstą",
  frthpar:
  ...
  firstimg:
    "https://firebasestorage.googleapis.com/v0/b/flats-af6d2.appspot.com/o/articles%2Fkaip-greitai-isnuomoti-busta%2Fkaip-greitai-isnuomoti-busta-vilniuje.jpg?alt=media&token=ff7d9c26-2075-48ad-afb5-f0fd5c0269e3",
  firstalt:
    "Būsto nuoma Lietuvoje: patarimai, kaip greitai surasti nuomininkus",
  scndimg:
    "https://firebasestorage.googleapis.com/v0/b/flats-af6d2.appspot.com/o/articles%2Fkaip-greitai-isnuomoti-busta%2Fkaip-greitai-isnuomoti-busta.jpg?alt=media&token=ef739327-3634-41eb-85ff-b428bfa64a76",
  scndalt:
    "Kaip greitai išnuomoti būstą Lietuvoje? Patarimai, kaip patraukliai pristatyti savo nekilnojamąjį turtą",
  trdimg:
...
export const articleNine = {
  ...
  firstimg:
    "https://firebasestorage.googleapis.com/v0/b/flats-af6d2.appspot.com/o/articles%2Fkaip-paruosti-buta-nuomai%2Fkaip-paruosti-buta-nuomai.jpg?alt=media&token=544b1a5d-0668-4de1-8784-04fd0c779f87",
  firstalt:
    "Buto nuoma Lietuvoje: patarimai, kaip paruošti butą nuomai ir surasti nuomininkus",
  scndimg:
    "https://firebasestorage.googleapis.com/v0/b/flats-af6d2.appspot.com/o/articles%2Fkaip-paruosti-buta-nuomai%2Fpigiai-paruosti-buta-nuomai-vilniuje.jpg?alt=media&token=5fa93001-3704-48f7-8851-35647ba2ec89",
  scndalt:
    "Kaip paruošti butą nuomai Lietuvoje? Patarimai, kaip apsaugoti savo turtą ir užtikrinti greitą nuomą",
  trdimg:
...
export const articleTen = {
  ...
  firstpar:
    "Nuomos turto valdymas gali būti puikus būdas generuoti pasitenkinimą keliančią pajamą, tačiau nuomos turto valdymo tipai gali skirtis labai. Vieni iš populiariausių nuomos turto valdymo tipų yra ilgalaikis nuomos valdymas ir trumpalaikis. Abiem tipais yra savų privalumų ir trūkumų, todėl svarbu suprasti skirtumus, prieš nusprendžiant, kurį iš jų pasirinkti.",
  scndheader: "Plačiau apie ilgalaikį nuomos administravimą",
  scndpar:
    "Ilgalaikė nuoma reiškia nuomoti turtą periodui, lygiam arba ilgesniam nei metus. Didžiausias ilgalaikės nuomos administravimo privalumas yra tai, kad jis tendencingai stabilus ir nuspėjamas. Ilgalaikiai nuomininkai mažiau linkę sugadinti turtą ar sukelti trikdžių, taip pat jiems lengviau planuoti priežiūrą ir remontus. Be to, ilgalaikiai nuomininkai dažniau elgsis taip, tarsi turtas būtų jų nuosavybė. Tačiau ilgalaikio nuomos turto valdymo trūkumas yra tai, kad gali būti sunkiau rasti patikimus nuomininkus, o procesas, kai reikia ieškoti ir patikrinti nuomininkus, gali užimti daug laiko. Be to, ilgalaikis nuomos turto valdymas gali būti mažiau lankstus ir gali neatnešti tiek pajamų kaip trumpalaikė nuoma.",
  trdheader: "Trumpalaikė nuoma ir jos ypatybės",
  trdpar:
  ...
  firstimg:
    "https://firebasestorage.googleapis.com/v0/b/flats-af6d2.appspot.com/o/articles%2Filgalaikes-nuomos-administravimas%2Filgalaike-nuoma-ir-jos-administravimas.jpg?alt=media&token=06080e8a-bc7d-4a5a-9f40-abaf08551f67",
  firstalt:
    "Nekilnojamasis turtas Lietuvoje: patarimai, kaip pasirinkti geriausią ilgalaikės nuomos administravimo paslaugą",
  scndimg:
    "https://firebasestorage.googleapis.com/v0/b/flats-af6d2.appspot.com/o/articles%2Filgalaikes-nuomos-administravimas%2Filgalaikes-nuomos-administravimas.jpg?alt=media&token=5ceb2c34-f530-447c-b1e7-c670d701ff3f",
  scndalt:
    "Ilgalaikės nuomos administravimas Lietuvoje: patarimai, kaip apsaugoti savo turtą ir užtikrinti jo efektyvų valdymą",
  trdimg:
...
export const articleEleven = {
  id: 11,
  url: "/straipsniai/pasyvios-pajamos-is-nekilnojamo-turto",
  ...
  firstpar:
    "Pasyvus pajamų šaltinis yra puikus būdas uždirbti pinigus be aktyvaus darbo. Vienas iš populiariausių būdų uždirbti pasyvias pajamas yra nuomojant nekilnojamąjį turtą. Turėdami vieną ar kelis nuomos turto objektus, galite gauti stabilų pajamų srautą be reikalo aktyviai rūpintis objektu. Šiame straipsnyje aptarsime nuomojant nekilnojamąjį turtą kaip pasyvios pajamos šaltinio privalumus, taip pat keletą strategijų, kaip sukurti sėkmingą nuomos turto portfelį.",
  ...
  firstimg:
    "https://firebasestorage.googleapis.com/v0/b/flats-af6d2.appspot.com/o/articles%2Fpasyvios-pajamos-is-nekilnojamo-turto%2Fkaip-gauti-pasyvias-pajamas-is-nekilnojamo-turto.jpg?alt=media&token=529bf04d-edb6-46aa-9f49-73915726b8b4",
  firstalt:
    "Išmokite, kaip sukurti sėkmingą nuomos turto portfelį ir gauti stabilias pasyvias pajamas",
  scndimg:
    "https://firebasestorage.googleapis.com/v0/b/flats-af6d2.appspot.com/o/articles%2Fpasyvios-pajamos-is-nekilnojamo-turto%2Fpasyvios-pajamos-is-nekilnojamo-turto-lietuvoje.jpg?alt=media&token=a8fefda6-7605-4e34-a26e-e4ad21932617",
  scndalt:
    "Nuomojant nekilnojamąjį turtą - puikus būdas uždirbti pasyvias pajamas be aktyvaus darbo",
  trdimg:
...
export const articleTwelve = {
  id: 12,
  url: "/straipsniai/nt-brokerio-paslaugu-altervatyva",
  seotitle: "NT brokerio paslaugų altervatyva",
  seocontent:
    "Šiame straipsnyje rasite informacijos apie NT brokerio paslaugų altervatyva. Jeigu kils papildomu klausimų lauksime Jūsų užklausos.",
  headerone: "NT brokerio paslaugų altervatyva - turto administratoriai",

  header: "NT brokerio paslaugų trūkumai",
  firstpar:
    "Kai nekilnojamojo turto pramonė auga, taip pat keičiasi turimos galimybės savininkams ir investuotojams. Nors tradicinės nekilnojamojo turto brokeriavimo paslaugos ilgai buvo populiarios pirkimo, pardavimo ir nuomos srityse, alternatyvi galimybė pradeda populiarėti: nekilnojamojo turto valdymo paslaugos. Vienas iš pagrindinių nekilnojamojo turto valdymo paslaugų privalumų yra sąnaudų sumažinimas. Valdymo įmonės įdarbinimas gali ilgalaikėje perspektyvoje sutaupyti savininkams pinigų. Gerai veikianti valdymo įmonė gali tvarkyti nuosavybės kasdienines operacijas, tokias kaip nuomos gavimas, priežiūra ir santykiai su nuomininkais, leisdama savininkams koncentruotis į kitas savo verslo ar asmeninio gyvenimo sritis. Be to, valdymo įmonės dažnai turi įsigytus santykius su tiekėjais, dėl ko gali gauti nuolaidas paslaugoms, tokioms kaip aplinkos tvarkymas, remontas ir valymas. Kita vertus NT brokerio paslaugos apima tik nuomininkų paieškas ir nenusileidžia kainomis nuo NT administratoriu.",
  scndheader: "NT brokerio paslaugų alternatyvos gali padidinti efektyvumą",
  scndpar:
    "Kita nekilnojamojo turto valdymo paslaugų privaluma yra didelis efektyvumas. Valdymo įmonė turi išteklių ir profesionalų, kurie gali tvarkyti daugelį reikalingų užduočių, reikalingų NT administravimui. Jie gali tvarkyti viską nuo reklamos ir nuosavybės parodymo potencialiems nuomininkams, iki atlikimo patikrinimų ir kredito patikrinimų, iki sutarčių ir atnaujinimo. Jie taip pat gali tvarkyti kasdienines užduotis, tokias kaip nuomos gavimas ir atsakymai į remonto prašymus. Tai leidžia savininkams koncentruotis į kitas savo verslo ar asmeninio gyvenimo sritis, be to, be reikalo nereikės praleisti laiko kasdieniniam NT valdymui.",
  trdheader: "Profesionalumo lygis",
  trdpar:
    "Nekilnojamojo turto valdymo paslaugos taip pat gali suteikti toki profesionalumo lygį, kuris gali būti sunkiai pasiekiamas individualiam savininkui ar NT brokeriui. NT administravimo įmonė turės profesionalų personalą, kuris bus apmokytas visose nekilnojamojo turto valdymo srityse, nuo teisinės ir finansinės problematikos iki rinkodaros ir reklamos. Jie taip pat turės išteklius ir profesionalumą, sprendžiant sunkias situacijas, tokias nuominikš nemokumas. Šis profesionalumo lygis gali sukelti geresnę patirtį nuomininkams, o tai gali suteikti aukštesnį nuomos užimtumą ir daugiau pajamų savininkui.",
  frthheader: "NT brokerio paslaugų alternatyvų privalumai",
  frthpar:
  ...
  firstimg:
    "https://firebasestorage.googleapis.com/v0/b/flats-af6d2.appspot.com/o/articles%2Fnt-brokerio-paslaugu-alternatyva%2Fnt-brokerio-paslaugu-altervatyva-turto-administratoriai.jpg?alt=media&token=6cd37079-99d0-4b75-86fd-4c22a6f95916",
  firstalt:
    "Ieškote alternatyvos nekilnojamojo turto brokerio paslaugoms? Apsvarstykite nekilnojamojo turto valdymo paslaugas, kurios gali pasiūlyti profesionalumą ir patikimumą.",
  scndimg:
    "https://firebasestorage.googleapis.com/v0/b/flats-af6d2.appspot.com/o/articles%2Fnt-brokerio-paslaugu-alternatyva%2Fnt-brokerio-paslaugu-altervatyva-vilniuje.jpg?alt=media&token=f30a0b2c-4833-4460-b7f2-4c0c7a890693",
  scndalt:
    "Nekilnojamojo turto valdymo paslaugos - tai nekilnojamojo turto brokerio paslaugų altervatyva, kurios gali pasiūlyti daugiau naudos savininkams ir investuotojams.",
  trdimg:
